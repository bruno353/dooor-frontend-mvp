    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/10 backdrop-blur-sm">
      <div className="w-[600px] rounded-xl bg-white p-6 shadow-lg">
        <div className="relative h-[300px]">
          ...
          >
            <div className="flex h-32 w-32 items-center justify-center rounded-full bg-purple/50">
              <div className="text-center">
          ...
          >
            <div className="flex h-28 w-28 items-center justify-center rounded-full bg-red/50">
              <div className="text-center">
                ...
                <div className="mt-1 text-xs text-red/40">LLM Processing</div>
              </div>
            </div>
          </div>
          ...
          {/* Hash Information */}
          <div className="absolute bottom-0 left-0 right-0 flex justify-between px-8 text-xs text-gray/50">
